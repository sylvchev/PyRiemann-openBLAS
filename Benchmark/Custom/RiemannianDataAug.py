...
for i in range(0, len(size)):
    ...
    t = timeit.Timer("compute(matrix_order, 5)",
                     setup="from Benchmark.Custom.RiemannianDataAug.RiemannianDataAugOld import compute; from __main__ import matrix_order")
    old_time = t.timeit(number=5) / 5

    t = timeit.Timer("compute(matrix_order, 5)",
                     setup="from Benchmark.Custom.RiemannianDataAug.RiemannianDataAugNew import compute; from __main__ import matrix_order")
